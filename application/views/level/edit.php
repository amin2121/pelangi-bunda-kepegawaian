          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item">Edit Level
                      </li>
                  </ul>
              </div>
          </div>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block panels-wells">
                              <form action="<?php echo base_url(); ?>level/edit" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="id" value="<?= $row['id'] ?>">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Nama Level</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="nama_level" class="form-control" required value="<?= $row['nama_level'] ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
