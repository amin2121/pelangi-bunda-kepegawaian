...
$('.check_status').click(function(){
	...
	$('#btn_simpan').click(function(){
			$.ajax({
				 url : '<?php echo base_url(); ?>stok_barang/simpan',
	...
	function alert_konfirmasi(){
			 swal({
						 ...
						 text: "Anda akan mengganti harga jual dan harga awal barang yang sudah ada!",
						 type: "warning",
					 ...
					 function(isConfirm) {
						 if (isConfirm) {
							 ...
							 $('#form_stok_barang').prop('action', '<?php echo site_url();?>stok_masuk/tambah');
							 $("#form_stok_barang").submit();
							 e.preventDefault();
						 } else {
							 swal("Batal", "Proses telah dibatalkan", "error");
							 $('#form_stok_barang').prop('action', '<?php echo site_url();?>stok_masuk/tambah_tidak');
							 $("#form_stok_barang").submit();
							 e.preventDefault();
						 }
					 });
          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item">Tambah Stok Barang
                      </li>
                  </ul>
              </div>
          </div>
                                        ...
                                        <table id="tabel_tambah_barang" class="table table-striped table-bordered nowrap">
                                            ...
                                            <tbody>
                                              <tr>
                                                ...
                                                <td>
                                                  <input type="text" name="jumlah[]" class="form-control input_isi" id="jumlah_1" onkeyup="FormatCurrency(this); hitung_jumlah(1); hitung_total();" required />
                                                </td>
                                                <td>
                                                  <div class="input-group">
                                                    <span class="input-group-addon">Rp</span>
                                                    <input type="text" name="harga_jual[]" class="form-control input_isi" id="harga_jual_1" onkeyup="FormatCurrency(this); hitung_jumlah(1); hitung_total();" required />
                                                  </div>
                                                </td>
                                                <td>
                                                  <div class="input-group">
                                                    <span class="input-group-addon">Rp</span>
                                                    <input type="text" name="total_harga[]" class="form-control input_isi class_harga_beli" id="total_harga_1" onkeyup="FormatCurrency(this);" readonly required />
                                                  </div>
                                                </td>
                                                <td>
