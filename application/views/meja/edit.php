          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item">Edit Meja
                      </li>
                  </ul>
              </div>
          </div>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block panels-wells">
                              <form action="<?php echo base_url(); ?>meja/edit" method="POST">
                                <input type="hidden" value="<?php echo $row['id']; ?>" name="id" value="">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Nama Meja</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="nama_meja" class="form-control" value="<?php echo $row['nama_meja']; ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
