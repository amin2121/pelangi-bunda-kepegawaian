                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block panels-wells">
                              ...
                              <form action="<?php echo base_url(); ?>promo_otomatis/edit_promo_b" method="POST">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                          <div class="input-group">
                                            ...
                                            <input type="text" name="banyak_bayar" class="form-control" value="<?php echo number_format($row['banyak_bayar']); ?>" onkeyup="FormatCurrency(this);" required>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
