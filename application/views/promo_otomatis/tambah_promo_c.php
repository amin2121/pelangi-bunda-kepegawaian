                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block panels-wells">
                              ...
                              <form action="<?php echo base_url(); ?>promo_otomatis/tambah_promo_c" method="POST">
                                  <div id="form_produk">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                          <div class="input-group">
                                            <input type="text" name="banyak_beli" class="form-control" onkeyup="FormatCurrency(this);" required>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                          <div class="input-group">
                                            <input type="text" name="banyak_gratis" class="form-control" onkeyup="FormatCurrency(this);" required>
                                            <span class="input-group-addon">X</span>
                                          </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-10">
                                          <div class="border-checkbox-section">
                                            <div class="border-checkbox-group border-checkbox-group-primary">
                                                ...
                                                <input class="border-checkbox" type="checkbox" name="status_kelipatan" value="1" id="check_kelipatan">
