                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Beli A gratis B</h5>
                                <div class="card-header-right">
                                    <i class="icofont icofont-rounded-down"></i>
                                </div>
                            </div>
                            <div class="card-block panels-wells">
                              <span>Contoh : Beli Bakso ayam gratis es jeruk</span><br><br>
                              <form action="<?php echo base_url(); ?>promo_otomatis/edit_promo_c" method="POST">
                                <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                  <div id="form_produk">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Gratis (Pilih Salah Satu)</label>
                                        <div class="col-sm-10">
                                          <select class="js-example-basic-single col-sm-12" name="gratis_barang">
                                            <?php foreach ($produk as $p): ?>
                                              <option value="<?php echo $p['nama_barang']; ?>" <?php if ($p['nama_barang']==$row['gratis_barang']) {echo 'selected';} ?>><?php echo $p['nama_barang']; ?></option>
                                            <?php endforeach; ?>
                                          </select>
                                        </div>
                                      </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                          <div class="input-group">
                                            <input type="text" name="banyak_gratis" class="form-control" onkeyup="FormatCurrency(this);" value="<?php echo number_format($row['banyak_gratis']); ?>" required>
                                            <span class="input-group-addon">X</span>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Berlaku Kelipatan</label>
                                        <div class="col-sm-10">
                                          <div class="border-checkbox-section">
                                            <div class="border-checkbox-group border-checkbox-group-primary">
                                                <input type="hidden" name="status_kelipatan" value="0">
                                                <input class="border-checkbox" type="checkbox" name="status_kelipatan" value="1" id="check_kelipatan" <?php if ($row['status_kelipatan'] == '1') { echo 'checked'; } ?>>
                                                <label class="border-checkbox-label" for="check_kelipatan"></label>
                                            </div>
                                        </div>
                                      </div>
                                    </div>
