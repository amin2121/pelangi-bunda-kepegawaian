                              ...
                              <form action="<?php echo base_url(); ?>barang/tambah" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="js-example-basic-single col-sm-12" name="id_jenis_barang">
                                              <?php foreach ($jenis_barang as $jb): ?>
                                                <option value="<?php echo $jb['id']; ?>"><?php echo $jb['nama_jenis_barang']; ?></option>
                                              <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          <div class="input-group">
                                            ...
                                            <input type="text" id="harga_awal" name="harga_awal" class="form-control" onkeyup="FormatCurrency(this); hitung_laba();" required>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" id="harga_jual" name="harga_jual" class="form-control" onkeyup="FormatCurrency(this); hitung_laba();" required>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          <div class="input-group">
                                            <span class="input-group-addon">Rp</span>
                                            <input type="text" id="laba" name="laba" class="form-control" onkeyup="FormatCurrency(this);" required>
                                          </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          <div class="border-checkbox-section">
                                            <div class="border-checkbox-group border-checkbox-group-primary">
                                                ...
                                                <input class="border-checkbox check_status" type="checkbox" name="status_produksi" value="1" id="checkbox0">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                          ...
                                          <a href="<?php echo base_url(); ?>barang"><button type="button" class="btn btn-warning" name="button"><i class="fa fa-mail-reply"></i>Kembali</button></a>
                                        </div>
                                    </div>
                                </form>
                            </div>
