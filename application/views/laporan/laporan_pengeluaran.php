          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>laporan_pengeluaran">Laporan Pengeluaran</a>
                      </li>
                  </ul>
              </div>
          </div>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Data Laporan Pengeluaran</h5>
                            ...
                            <form action="<?php echo base_url(); ?>laporan_pengeluaran/print_laporan" target="_blank" method="POST" id="form_cek">
