          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>laporan_laba_rugi">Laporan Laba Rugi</a>
                      </li>
                  </ul>
              </div>
          </div>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block panels-wells">
                              ...
                              <form action="<?php echo base_url(); ?>laporan_laba_rugi/print_laporan" target="_blank" method="POST" id="form_cek">
