        ...
        <?php
          ...
          <tr>
            ...
            <td style="text-align:center;">
              <?php echo $r['nama_pengeluaran']; ?> Bulan <?php echo $nama_bulan; ?>
            </td>
          ...
          <tr>
            ...
            <td style="text-align:center;">
              <?php
                if ($r['status'] == 'Faktur') {
                ?>
                <?php echo $r['nama_supplier']; ?> / Faktur  <?php echo $r['nama_pengeluaran']; ?>
              <?php
              }elseif ($r['status'] == 'Retur Penjualan') {
                ?>
                Retur Penjualan - <?php echo $r['nama_pengeluaran']; ?>
              <?php
              }else {
                ?>
                <?php echo $r['nama_pengeluaran']; ?>
              <?php
                }
               ?>
            </td>
