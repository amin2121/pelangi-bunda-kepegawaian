          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>laporan_penjualan_detail">Laporan Penjualan Detail</a>
                      </li>
                  </ul>
              </div>
          </div>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Data Laporan Penjualan Detail</h5>
                            ...
                            <div class="card-block panels-wells">
                                ...
                                <form action="<?php echo base_url(); ?>laporan_penjualan_detail/print_laporan" target="_blank" method="POST" id="form_cek">
                                  ...
                                  <div id="form_hari">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                          <select class="form-control" name="user_hari">
                                  ...
                                  <div id="form_bulan">
                                    <div class="form-group row">
                                        ...
                                        <?php if ($this->session->userdata('level') == 'Admin'): ?>
                                        <div class="col-sm-2">
                                          <select class="form-control" name="user_bulan">
                                            <option value="semua">Semua</option>
                                            <?php foreach ($user as $u): ?>
                                              <option value="<?php echo $u['id']; ?>"><?php echo $u['nama_lengkap']; ?></option>
                                            <?php endforeach; ?>
                                  ...
                                  <div id="form_tahun">
                                    <div class="form-group row">
                                        ...
                                        <?php if ($this->session->userdata('level') == 'Admin'): ?>
                                        <div class="col-sm-2">
                                          <select class="form-control" name="user_tahun">
                                            <option value="semua">Semua</option>
                                            <?php foreach ($user as $u): ?>
                                              <option value="<?php echo $u['id']; ?>"><?php echo $u['nama_lengkap']; ?></option>
                                            <?php endforeach; ?>
