          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>laporan_buku_stok">Laporan Buku Stok</a>
                      </li>
                  </ul>
              </div>
          </div>
              ...
              <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <form action="<?php echo base_url(); ?>laporan_buku_stok/print_laporan" target="_blank" method="POST" id="form_cek">
                              <div id="form_hari">
