      ...
      <div class="page-wrapper">
          <div class="page-header">
              <div class="page-header-title">
                  <h4>Laporan Pengeluaran Per Supplier</h4>
              </div>
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>laporan_pengeluaran_per_supplier">Laporan Pengeluaran Per Supplier</a>
                      </li>
                  </ul>
              </div>
          </div>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Data Laporan Pengeluaran Per Supplier</h5>
                            ...
                            <form action="<?php echo base_url(); ?>laporan_pengeluaran_per_supplier/print_laporan" target="_blank" method="POST">
