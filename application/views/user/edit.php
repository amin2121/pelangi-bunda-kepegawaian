                            ...
                            <div class="card-block panels-wells">
                              <form action="<?php echo base_url(); ?>user/edit" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nama_toko" value="<?php echo $row['nama_toko']; ?>" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="no_telepon" value="<?php echo $row['no_telepon']; ?>" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">ktp</label>
                                        <div class="col-sm-10">
                                            <input type="hidden" name="ktp_hidden" value="<?php echo $row['ktp']; ?>">
                                    ...
                                    <input type="hidden" name="password_hidden" value="<?php echo $row['password']; ?>">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="level">
                                                ...
                                                <?php foreach ($level as $key => $l): ?>
                                                    <option value="<?= $l['id'] ?>" <?= ($l['id'] == $row['id_level']) ? 'selected' : '' ?>><?= $l['nama_level'] ?></option>
                                                <?php endforeach ?>
                                            </select>
                                        </div>
                                    </div>
