...
<script type="text/javascript">
  ...
  function data_barang(){
    $('#popup_load').show();
    $.ajax({
    	url : '<?php echo base_url(); ?>riwayat_penjualan/riwayat_penjualan_result',
    	type : "POST",
    	dataType : 	"json",
           ...
           if (result[i].status_diskon == '1') {
              ...
              status_diskon = '';
    				...
    				$table += '<tr>'+
                        ...
                        '<button class="btn btn-danger btn-sm" type="button" onclick="hapus_penjualan('+result[i].id+');"><i class="fa fa-trash"></i>Batalkan Transaksi</button>'+
                        '</td>'+
                      '</tr>';
  ...
  function filter_tanggal(){
    ...
    $('#popup_load').show();
    $.ajax({
    	url : '<?php echo base_url(); ?>riwayat_penjualan/filter_tanggal',
  ...
  function detail_penjualan(id, total){
    ...
    $.ajax({
    	url : '<?php echo base_url(); ?>riwayat_penjualan/detail_penjualan',
      data : {id:id},
    	type : "POST",
    	dataType : 	"json",
    	success : function(result){
  ...
  function filter_no_transaksi(){
    ...
    $('#popup_load').show();
    $.ajax({
    	url : '<?php echo base_url(); ?>riwayat_penjualan/filter_no_transaksi',
      data : {search:search},
    	type : "POST",
    	dataType : 	"json",
    	success : function(result){
  ...
  function hapus_penjualan(id){
    swal({
			...
			text: "Tuliskan alasan di hapusnya transaksi",
			type: "input",
			...
			if (inputValue === "") {
				swal.showInputError("Inputan harus di isi!");
				return false
			}else {
        swal("Berhasil!", "Transaksi Penjualan Telah Dibatalkan", "success");
        $.ajax({
             url: '<?php echo base_url();?>riwayat_penjualan/hapus_penjualan',
             data : {
                      id:id,
          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>riwayat_penjualan">Riwayat Penjualan</a>
                      </li>
                  </ul>
              </div>
          </div>
