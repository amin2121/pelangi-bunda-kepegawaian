...
<script type="text/javascript">
  ...
  function data_barang(){
    $('#popup_load').show();
    $.ajax({
    	url : '<?php echo base_url(); ?>riwayat_hapus_penjualan/riwayat_hapus_penjualan_result',
    	type : "POST",
    	dataType : 	"json",
    	success : function(result){
          ...
          for(var i=0; i<result.length; i++){
            ...
            var link = '<?php echo base_url(); ?>riwayat_hapus_penjualan/cetak_struk/'+result[i].id;
           ...
           if (result[i].status_diskon == '1') {
              ...
              status_diskon = '';
    				...
    				$table += '<tr>'+
                        ...
                        ''+nama_lengkap+''+
                        '<td style="text-align:center;">'+result[i].atas_nama+'</td>'+
                        ...
                        '<a href="'+link+'" target="_blank"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-print"></i>Print</button></a>&nbsp;'+
                        ...
                        '<button class="btn btn-danger btn-sm" type="button" onclick="hapus_penjualan('+result[i].id+');"><i class="fa fa-trash"></i>Hapus Transaksi</button>'+
                        '</td>'+
                      '</tr>';
  ...
  //   var jawab = confirm("Apakah anda ingin membatalkan pesanan?");
  //     if (jawab === true) {
  //       $.ajax({
  //            url: '<?php //echo base_url();?>riwayat_penjualan/hapus_penjualan',
  //            data : {id:id},
  //            dataType : "json",
  //            type: "POST",
  //            async : false,
  ...
  function filter_tanggal(){
    ...
    $('#popup_load').show();
    $.ajax({
    	url : '<?php echo base_url(); ?>riwayat_hapus_penjualan/filter_tanggal',
  ...
  function detail_penjualan(id, total){
    ...
    $.ajax({
    	url : '<?php echo base_url(); ?>riwayat_hapus_penjualan/detail_hapus_penjualan',
      data : {id:id},
    	type : "POST",
    	dataType : 	"json",
    	success : function(result){
  ...
  function filter_no_transaksi(){
    ...
    $('#popup_load').show();
    $.ajax({
    	url : '<?php echo base_url(); ?>riwayat_hapus_penjualan/filter_no_transaksi',
      data : {search:search},
    	type : "POST",
    	dataType : 	"json",
    	success : function(result){
  ...
  function hapus_penjualan(id){
    swal({
      ...
      closeOnConfirm: false,
        ...
        if (willDelete) {
          $.ajax({
             url: '<?php echo base_url();?>riwayat_hapus_penjualan/hapus_penjualan',
             data : {id:id},
             dataType : "json",
             type: "POST",
             async : false,
          ...
          <div class="page-header">
              ...
              <div class="page-header-breadcrumb">
                  <ul class="breadcrumb-title">
                      ...
                      <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>riwayat_hapus_penjualan">Riwayat Hapus Penjualan</a>
                      </li>
                  </ul>
              </div>
          </div>
                ...
                <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5>Data Riwayat Hapus Penjualan</h5>
                            ...
                            <div class="card-block panels-wells">
                              ...
                              <div id="form_filter_tanggal">
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                      <input type="date" class="form-control" id="tanggal_dari" name="dari" required value="<?= date('Y-m-d') ?>">
                                    </div>
                                    <div class="col-sm-2">
                                      <input type="date" class="form-control" id="tanggal_sampai" name="sampai" required value="<?= date('Y-m-d') ?>">
                                    </div>
                                    <div class="col-sm-2">
