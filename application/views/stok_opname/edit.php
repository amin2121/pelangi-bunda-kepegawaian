                                              ...
                                              <?php foreach ($stok_detail as $key => $stok): ?>
                                                <tr>
                                                  ...
                                                  <td>
                                                    <div class="input-group">
                                                      <span class="input-group-addon">Rp</span>
                                                      <input type="text" name="total_harga[]" class="form-control input_isi class_harga_beli" id="total_harga_<?= ++$key ?>" onkeyup="FormatCurrency(this);" readonly required value="<?= number_format($stok['total_semua']) ?>"/>
                                                    </div>
                                                  </td>
                                                  <td>
